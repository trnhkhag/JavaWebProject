        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="Changepassword" method="post" name="pass_form" onsubmit="return validatePassword()" >
                        ...
                        <div class="input-group form-group">
                            ...
                            <input type="password" class="form-control" placeholder="Confirm Password" id="cpass" name="confpass">
                        </div>
